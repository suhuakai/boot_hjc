...
public final class LocalStringUtils {
     ...
     *
     */
    public static List<String> splitToList(String string, String splitToken) throws RRException {
     ...
     *
     */
    public static String caseWhen(String... multiValues) throws RRException {
        Assert.notEmpty(multiValues, "multiValues，非空");
        ...
        if (findTarget) {
            ...
            throw new RRException(first + "：码值未识别！");
        }
    }
