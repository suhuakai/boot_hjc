function showimage(source) {
    ...
    $("#img_url").attr("src", "http://cdn.szlzpt.com/" + source);
}
...
$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [
            ...
            {
                label: '图片路径', name: 'url', index: 'url', width: 80, formatter: function (value) {
            ...
            {label: '实际充值金额', name: 'realityNumber', index: 'reality_number', width: 80},
            {
                label: '支付类型', name: 'useType', index: 'useType', width: 80, formatter: function (value) {
                    ...
                    if (value == "wechat") {
                        return '<span class="label label-info" style="background-color:#d8bf7c ">微信</span>';
                    }
                }
            },
    ...
    methods: {
        ...
        reload: function (event) {
            ...
            $("#jqGrid").jqGrid('setGridParam', {
                postData: {
                    "userId": vm.withdraw.userId,
                    "type": vm.withdraw.type,
                    "useType": vm.withdraw.useType
                },
                page: page
            }).trigger("reloadGrid");
        }
